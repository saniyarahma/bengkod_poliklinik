        ...
        ?>
            <tr>
                ...
                <td>
                    ...
                    <a class="btn btn-danger rounded-pill px-3" href="index.php?page=periksa&id=<?php echo $data['id'] ?>&aksi=hapus" name="aksi">Hapus</a>
                    <a target="_blank" class="btn btn-warning rounded-pill px-3" href="index.php?page=invoice&id=<?= $data['id'] ?>">Nota</a>
                </td>
            </tr>
        <?php
        }
